...
/// minor bump, then the paused-state play overlay and seek-only marker/chapter jumps, then the 0.9.1 footer stamp, then the play overlay became a large monospace |>, then the 0.9.2 footer stamp. When
...
fn generated_page_is_byte_identical_to_the_serde_era_renderer() {
  ...
  assert_eq!(got, (94736, 0xd644e9870c0df1b4, 94526, 0xc9377f20c8253a1d), "the generated page's bytes moved");
}
